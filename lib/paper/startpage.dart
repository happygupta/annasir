...
import 'package:annasir/paper/paper.dart';
import 'package:annasir/paper/scoreboard.dart';
...
class StarTestPage extends StatefulWidget {
  final int paper;
  StarTestPage(this.paper);
  @override
  _StarTestPageState createState() => _StarTestPageState();
}

class _StarTestPageState extends State<StarTestPage> {
                                ...
                                if (status == 'Paid') {
                                  if (member == 'Y') {
                                    Navigator.push(
                                        context,
                                        SlideRightRoute(
                                            page: TestScreen(paperCode, time)));
                                  } else {
                                    Fluttertoast.showToast(
                                        msg: 'You are not a Prime Member');
                                  }
